...
def bertimbau_model(training_config, train_data, test_data):
    ...
    global model
    model = AutoModelForSequenceClassification.from_pretrained("neuralmind/bert-base-portuguese-cased", num_labels=2) #  BERTimbau-base 
...
def main(): 
    ...
    training_args = TrainingArguments(
        output_dir='./results_test_bert_base',
        num_train_epochs=10,
    ...
    # Salvar o modelo
    model.save_model('bertimbau-base-fine-tune')
